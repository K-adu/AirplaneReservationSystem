...
using namespace std;
   ...
   char l_destination[5][20]={"POKHARA","KATHMANDU","BIRATNAGAR","BIRJUNG","SYANGJA"};
...
public:
 void getdata()
 {
  ...
  cout<<"\n\n\nEnter the firstname of passenger: ";
   ...
   cin.getline(dest,60);
   cout<<"Enter dd/mm/yy in B.S";
   cin.getline(day,60);cout<<"/";cin.getline(month,60);cout<<"/";cin.getline(year,60);
   cout<<endl<<endl;
   system("CLS");
 }
 void show()
...
public:
 void getdata()
 {
  ...
  cout<<"1)YETI AIR"<<endl;
  cout<<"2)BUDDHA AIR"<<endl;
  ...
  case 1:
   if (option==1)
    cout<<setw(40)<<"\n\n\n                                WELCOME TO YETI AIR"<<endl;
   break;
  case 2:
   if(option==2)
    cout<<setw(40)<<"\n\n\n                                WELCOME TO BUDDHA AIR"<<endl;
   break;
  case 3:
   if(option==3)
...
int main()
{
 ...
 Sleep(2500);
 system ("cls");
 cout<<"\n\n\n\n\n\n\n\t\t\t         Developer:Mr.Manish Baral";
 Sleep(2500);
 system("cls");
 cout<<"\n\n\n\n\n\n\n\n\n\n\t\t\t\t   Report problem at manishbaral112@gmail.com";
 Sleep(2500);
 system ("cls");
